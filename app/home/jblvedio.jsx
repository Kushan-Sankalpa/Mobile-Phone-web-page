...
import styles from "./jblvedio.module.css";

export default function JblVedio({
  title = "",
  src = "/media/jblshort.mp4", // put jblshort.mp4 in /public/media
}) {
  ...
  return (
    <section className={styles.section} aria-label="JBL video">
      <div className={styles.inner}>
        ...
        {/* Optional: if you want a title under the video */}
